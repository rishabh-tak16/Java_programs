    ...
    {  
        public static void main(String args[])   
            {  
                ...
                else if(1500<=subtotal && subtotal<2500)
                {
                    bucks_won= "Silver"; 
                }
                ...
                {
                     bucks_won= "Better luck next time";
                }

                int totBucks=0;
                int t=0;
                double bsubtotal=0.0;

                System.out.println("Do you have any BONUS BUCKS ?");
                String has=scan.next();

                if(has.equals("yes"))                                //has bucks
                {               
                System.out.println("Which bonus bucks do you have Bronze, Silver, Gold");
                String bonus=scan.next();//Line().trim();
                System.out.println("How many bucks");
                t=scan.nextInt();
                System.out.println("Want to apply yes or no");
                //scan.next();
                String bchoice=scan.next();

                //5555555555555555555555555555555555555555555555555555555555555555555555555555555555555
                if(bchoice.equals("yes"))                    ////choice 1
                {

                if(bonus.equals("Bronze") || bonus.equals("bronze"))
                {
                    bsubtotal=subtotal-subtotal*t*2.5/100;
                    //System.out.println("\n\t\t\t\t\t\t\t\t\t\t          Price after applying Bonus Bucks "+subtotal); 
                }

                else if(bonus.equals("Silver") || bonus.equals("silver"))
                {
                    bsubtotal=subtotal-subtotal*t*3/100;
                    //System.out.println("\n\t\t\t\t\t\t\t\t\t\t          Price after applying Bonus Bucks "+subtotal); 
                }

                else if(bonus.equals("Gold") || bonus.equals("gold"))
                {
                    bsubtotal=subtotal-subtotal*t*4.5/100;
                    //System.out.println("\n\t\t\t\t\t\t\t\t\t\t          Price after applying Bonus Bucks "+subtotal); 
                }
                else
                {System.out.println("Bucks entered is incorrect");}
                        ...
                        //discount = overAllPrice*51/100;  
                        System.out.println("\n\t\t\t\t\t\t\t\t\t\t       Discount (Rs.) " +discount);  
                        //total amount after discount  
                        //subtotal = overAllPrice-discount;   
                        System.out.println("\n\t\t\t\t\t\t\t\t\t\t        Subtotal "+subtotal);
                        //after applying bonus bucks
                        System.out.println("\n\t\t\t\t\t\t\t\t\t\tPrice after applying Bonus Bucks "+bsubtotal); 
                        //calculating tax  
                ...
                System.out.println("\n\t\t\t\t\t\t\t\t Your total Bucks are: 1 "+bucks_won+"(earned bucks)"+"  +  "+t+" "+bonus+" (previous bucks)");
